...
export default function KeeperdayRegistrationErrorPage() {
        ...
        <Card className="border-white/60 bg-white/85 shadow-[0_30px_60px_rgba(15,23,42,0.12)] backdrop-blur-xl">
          ...
          <CardContent className="space-y-6 text-center">
            <p className="text-sm text-slate-600 md:text-base">
              Bitte versuche es erneut. Wenn das Problem bestehen bleibt, kontaktiere uns.
            </p>
            <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
              <Button type="button" onClick={() => router.push('/keeperdays/register')}>
                Zurueck zur Anmeldung
              </Button>
              <Button
                type="button"
                variant="outline"
                onClick={() => router.push('/keeperdays')}
              >
                Keeperdays ansehen
              </Button>
            </div>
