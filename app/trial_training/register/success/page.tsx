...
export default function TrialTrainingRegistrationSuccessPage() {
        ...
        <Card className="border-white/60 bg-white/85 shadow-[0_30px_60px_rgba(15,23,42,0.12)] backdrop-blur-xl">
          <CardHeader className="gap-3 text-center">
            ...
            <CardTitle className="text-2xl md:text-3xl">
              Anmeldung zum Schnuppertraining erfolgreich
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-6 text-center">
            <p className="text-sm text-slate-600 md:text-base">
              Vielen Dank für deine Anmeldung zum kostenlosen Schnuppertraining. Du erhaelst eine
              Bestaetigungs-E-Mail. Bitte pruefe auch deinen Spam-Ordner.
            </p>
            <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
              <Button type="button" onClick={() => router.push('/trial_training/register')}>
                Weitere Anmeldung
              </Button>
